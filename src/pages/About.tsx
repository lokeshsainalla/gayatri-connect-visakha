      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section>
          <Card className="shadow-card bg-primary text-primary-foreground">
            <CardHeader>
              <CardTitle className="text-2xl text-center">Principal's Message</CardTitle>
            </CardHeader>
            <CardContent className="p-8">
              <div className="max-w-4xl mx-auto text-center">
                <p className="text-lg leading-relaxed mb-6 opacity-90">
                  "At Sri Gayatri Junior College, we believe that education is not just about academic 
                  achievement, but about shaping character, building confidence, and preparing students 
                  for life's challenges. Our dedicated faculty and staff work tirelessly to ensure that 
                  every student receives personalized attention and guidance."
                </p>
                <p className="text-lg leading-relaxed opacity-90">
                  "We are committed to maintaining the highest standards of education while fostering 
                  an environment of innovation, creativity, and mutual respect. Together, we build not 
                  just successful students, but responsible citizens."
                </p>
                <div className="mt-8">
                  <p className="font-semibold text-lg">Dr. [Principal Name]</p>
                  <p className="opacity-90">Principal, Sri Gayatri Junior College</p>
                </div>
              </div>
            </CardContent>
          </Card>
